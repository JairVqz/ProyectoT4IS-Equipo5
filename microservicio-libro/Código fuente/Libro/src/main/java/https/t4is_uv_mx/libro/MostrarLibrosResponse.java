...
@XmlRootElement(name = "MostrarLibrosResponse")
public class MostrarLibrosResponse {

    @XmlElement(required = true)
    protected List<MostrarLibrosResponse.Libros> libros;
     ...
     * {@link MostrarLibrosResponse.Libros }
     * 
     * 
     */
    public List<MostrarLibrosResponse.Libros> getLibros() {
        if (libros == null) {
            libros = new ArrayList<MostrarLibrosResponse.Libros>();
        }
        return this.libros;
    }
